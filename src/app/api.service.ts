...
export class ApiService {
  ...
  logAccount(user: any): Observable<any[]> {
    ...
    return this.http.post<any[]>(apiUrl + 'auth/login', user, headers).pipe(
  ...
  createAccount(user: any): Observable<any[]> {
    ...
    return this.http.post<any[]>(apiUrl + 'auth/register', user, headers).pipe(
  ...
  getWastes(): Observable<any[]> {
    ...
    return this.http.get<any[]>(apiUrl + 'wastes', httpOptions).pipe(
      tap((res) => console.log('fetched wastes')),
      catchError(this.handleError('getWastes', []))
    );
  }
  ...
  getWaste(id: number): Observable<Waste> {
    ...
    return this.http.get<Waste>(url, this.httpOptions).pipe(
  ...
  addWaste(waste: any): Observable<Waste> {
    this.token = this.cookieService.get('token');
    return this.http
      .post<Waste>(`${apiUrl}wastes`, waste, this.httpOptions)
      .pipe(
